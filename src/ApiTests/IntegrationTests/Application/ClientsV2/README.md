# BenefitsApi.Client - the C# library for the User Benefit Cost Calculation Api
...
```
nuget pack -Build -OutputDirectory out BenefitsApi.Client.csproj
```
...
## Documentation for Models
 ...
 - [Model.GetUserDto](docs/GetUserDto.md)
 - [Model.GetUserDtoApiResponse](docs/GetUserDtoApiResponse.md)
 - [Model.GetUserDtoIReadOnlyCollectionApiResponse](docs/GetUserDtoIReadOnlyCollectionApiResponse.md)
